  ...
  <div class="col-12 mt-2">
    <div class="pull-right">
      <button type="submit" class="btn btn-primary btn-lg mb-3">
        <a style="color: #ffffff !important;" href="{{route('user.management.create')}}"><i class="fa fa-plus"></i> Tambah</a>
      </button>
    </div>
  </div>
</div>
<div class="row">
  ...
  <div class="col-12 mt-2">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">Data Table Users</h4>
          ...
          <table id="dataTable2" class="text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> {{$user->role}} </td>
                <td>
                  <a href="{{route('user.management.edit', $user)}}" class="btn btn-xs btn-warning"><i class="ti-pencil"></i> Edit</a>
