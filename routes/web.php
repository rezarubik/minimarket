...
Route::get('/master/supplier/{sp}/edit', 'SupplierController@edit')->name('supplier.edit');
Route::patch('/master/supplier/{sp}/edit', 'SupplierController@update')->name('supplier.update');
Route::delete('/master/supplier/{sp}/delete', 'SupplierController@destroy')->name('supplier.destroy');
...
Route::get('/master/customer/{customer}/edit', 'CustomerController@edit')->name('customer.edit');
Route::patch('/master/customer/{customer}/edit', 'CustomerController@update')->name('customer.update');
Route::delete('/master/customer/{customer}/delete', 'CustomerController@destroy')->name('customer.destroy');
...
Route::get('/master/product/{product}/edit', 'ProductController@edit')->name('product.edit');
Route::patch('/master/product/{product}/edit', 'ProductController@update')->name('product.update');
